Contributing to Ballotbox Core
============================

The Ballotbox Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ballotbox-project/ballotbox/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Ballotbox Core project, and is not to be
confused with overall Ballotbox Network Protocol consensus changes.

Whether a pull request is merged into Ballotbox Core rests with the project merge
...
The project leader is the release manager for each Ballotbox Core release.
