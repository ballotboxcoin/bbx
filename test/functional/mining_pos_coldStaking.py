...
from test_framework.ballotbox_node import BallotboxTestNode
...
class Ballotbox_ColdStakingTest(BallotboxTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BallotboxTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 BBX from the pot)
...
if __name__ == '__main__':
    Ballotbox_ColdStakingTest().main()
