...
class RawTransactionsTest(BallotboxTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ballotbox address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ballotbox address" in e.error['message'])
