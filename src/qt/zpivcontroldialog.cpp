// Copyright (c) 2017-2020 The Ballotbox developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zBBX Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zBBX.";
            else if (!mint.isSeedCorrect)
                strReason = "The zBBX seed used to mint this zBBX is not the same as currently hold in the wallet";
            else
