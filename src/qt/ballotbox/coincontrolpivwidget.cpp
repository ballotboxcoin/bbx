...
#include "qt/ballotbox/coincontrolpivwidget.h"
#include "qt/ballotbox/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BBX Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BBX");
    ...
    ui->labelValueAfter->setText("0.00 BBX");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BBX");
    ui->labelValueFee->setText("0.00 BBX");
