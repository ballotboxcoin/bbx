...
// Copyright (c) 2015-2018 The Ballotbox developers
...
#define QAPP_ORG_NAME "Ballotbox"
#define QAPP_ORG_DOMAIN "ballotbox.dev"
#define QAPP_APP_NAME_DEFAULT "Ballotbox-Qt"
#define QAPP_APP_NAME_TESTNET "Ballotbox-Qt-testnet"
