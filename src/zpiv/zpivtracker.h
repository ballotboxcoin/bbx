...
#ifndef Ballotbox_ZBBXTRACKER_H
#define Ballotbox_ZBBXTRACKER_H
...
public:
    CzBBXTracker(std::string strWalletFile);
    ~CzBBXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBBXWallet* zBBXWallet = NULL);
