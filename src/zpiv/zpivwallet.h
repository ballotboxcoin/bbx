...
#ifndef Ballotbox_ZBBXWALLET_H
#define Ballotbox_ZBBXWALLET_H
...
public:
    CzBBXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBBX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBBX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
