...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.push_back(Pair("zBBXsupply", zpivObj));
    ...
    if (block.IsProofOfStake()) {
        ...
        stakeData.push_back(Pair("stakeModifierHeight", ((stake->IsZBBX()) ? "Not available" : std::to_string(
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            "  \"zBBXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBBX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBBX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBBX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBBX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBBX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBBX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBBX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBBX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBBX denominations\n"
            "  }\n"
            "}\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), ZBBX_FAILED_ACCUMULATOR_INITIALIZATION);
