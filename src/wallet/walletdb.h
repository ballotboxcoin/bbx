...
public:
    ...
    bool WriteZBBXSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZBBXSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZBBXSeed_deprecated(uint256& seed);
    bool EraseZBBXSeed();
    bool EraseZBBXSeed_deprecated();

    bool WriteZBBXCount(const uint32_t& nCount);
    bool ReadZBBXCount(uint32_t& nCount);
