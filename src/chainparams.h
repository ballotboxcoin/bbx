...
public:
    ...
    int BallotboxBadBlockTime() const { return nBallotboxBadBlockTime; }
    int BallotboxBadBlocknBits() const { return nBallotboxBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBallotboxBadBlockTime;
    unsigned int nBallotboxBadBlocknBits;
