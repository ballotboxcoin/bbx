...
// Copyright (c) 2015-2019 The Ballotbox developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000b8a4b426d356357bbbaefaab442c31b882753085077ee34f4de0d4e8120"));
    //(500, uint256("0x0000042ff28adc30c4ebe9faa16e8a014bd9e327866413e0e536687e7c789c65"));// genesis
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1605096003, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 1769;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Ballotbox starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 400;
        nBallotboxBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nBallotboxBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 395;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Biden says Trump's actions are 'an embarrassment'";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1605096003;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 610866;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000b8a4b426d356357bbbaefaab442c31b882753085077ee34f4de0d4e8120"));
        assert(genesis.hashMerkleRoot == uint256("93977541b41e668254fec54d204a899c1cc9e983d673d2e9899944d7baac19f8"));
        //assert(genesis.hashMerkleRoot == uint256("38663931636161623764343439393938396532643337366433383965396363316339393861343032643435636566343532383636653134623134353737393339"));
        ...
        vSeeds.push_back(CDNSSeedData("45.76.6.98", "45.76.6.98"));
        ...
        strSporkPubKey = "04989c143c6033d16897bc302b65898765d942c7f17790ab9cfb369f18bb30f0fdde958811beda1af94914095d536ae8290e887bd9d801cdd3506d0dae1ea04da2";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nBallotboxBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nBallotboxBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ballotbox-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ballotbox-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.ballotbox.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ballotbox addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ballotbox script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ballotbox BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ballotbox BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ballotbox BIP44 coin type is '1' (All coin's testnet default)
