...
The build script we'll be using is contained in the Ballotbox github repository ([contrib/gitian-build.py](https://github.com/ballotbox-project/ballotbox/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Ballotbox repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Ballotbox-Project/Ballotbox/master/contrib/gitian-build.py
