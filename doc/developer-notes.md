...
- [Development guidelines](#development-guidelines)
    - [General Ballotbox Core](#general-ballotbox-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Ballotbox Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Ballotbox Core is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/ballotbox-project/ballotbox/blob/master/contrib/valgrind.supp))
...
However, in open source software such as Ballotbox Core, where everyone uses
...
pay attention to for reviewers of Ballotbox Core code.

General Ballotbox Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ballotbox Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Ballotbox Core so that they can be integrated
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:Ballotbox-Project/Ballotbox.git
