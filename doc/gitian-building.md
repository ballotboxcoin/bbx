...
*Setup instructions for a gitian build of Ballotbox Core using a VM or physical system.*
...
- [Building Ballotbox Core](#building-ballotbox-core)
...
[gitian.sigs](https://github.com/ballotbox-project/gitian.sigs/) repository:
